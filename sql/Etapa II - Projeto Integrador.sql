...
VALUES
('notebook', 2800.00, 'Notebook da  xuxa', 30, 'Possui garantia de 1 ano para falhas de fabrica e danos durante o transporte', 1, 1),
('bone do corinthians', 33.00, 'Bone preto com brasão do Corinthian na parte frontal e ajuste de tamanho trazeiro', 54, 'Não possui garantia', 2, 2),
('Harry Potter e a Pedra filosofal', 67.00, 'Livro do harry potter capa dura edição JBC 2003', 6, 'Não possui garantia', 3, 3),
('pote de marmita', 27.90, 'Vazilha para armazenar comida com 3 repartições', 98, 'Possui garantia de 3 meses para falhas de fabricação', 4, 4),
('creme para calvice', 60.00, 'Creme anti queda capiar, que estimula o cresimento de cabelo, 500g', 183, 'Não possui garantia', 5, 5),
('Conjunto de cadeiras', 83.00, 'Conjunto de cadeiras de madeira com 15 unidades', 17, 'Possui garantia de 6 meses para falhas de fabricação', 6, 6),
('capa para volante', 14.99, 'Capa protetora para volante, estampa animal print onça', 47,  'Não possui garantia', 7, 7),
('bicicleta', 660.00, 'Bicicleta para trilha com 5 marchas', 36, 'Possui garantia de 6 meses para falhas de fabricação', 8, 8),
('tabuleiro de xadres', 49.00, 'Tabuleiro de xadres convencional', 70, 'Possui garantia de 1 ano para falhas de fabrica e danos durante o transporte', 9, 9),
('action figure: Big Daddy - Bioshock', 900.00, 'Figure figma 15 cm com 3 variações de rosto', 3, 'Possui garantia de 5 meses para falhas de fabrica e danos durante o transporte', 10, 10)
;
