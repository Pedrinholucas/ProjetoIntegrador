...
public class UIFormCliente extends javax.swing.JFrame {
    ...
    if(Common.isInteger(cpfInput.getText()) && Common.isInteger(telefoneInput.getText())){
        Cliente obj = new Cliente(Integer.parseInt(cpfInput.getText()),nomeInput.getText(), senhaInput.getText(), emailInput.getText(),Integer.parseInt(telefoneInput.getText()));
        ConnectionMySQL teste = new ConnectionMySQL();
        Connection db = null;
        PreparedStatement pStatement = null;
        try {
            db = teste.conectar();
            String query = "INSERT INTO Cliente(cpf,nome, senha, email, telefone) VALUES ("+Integer.parseInt(cpfInput.getText())+", '"+nomeInput.getText()+"', '"+senhaInput.getText()+"','"+emailInput.getText()+"',"+Integer.parseInt(telefoneInput.getText())+")";
            pStatement = db.prepareStatement(query);
            int rows = pStatement.executeUpdate();
            if(rows > 0){
                JOptionPane.showMessageDialog(null, "Conta Clinete registrada com exito!");
